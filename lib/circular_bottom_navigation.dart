...
class _CircularBottomNavigationState extends State<CircularBottomNavigation>
  ...
  Animation? selectedPosAnimation;
  Animation? itemsAnimation;

  List? _itemsSelectedState;
      ...
      setState(() {
        _itemsSelectedState!.asMap().forEach((i, value) {
          if (i == previousSelectedPos) {
            _itemsSelectedState![previousSelectedPos!.toInt()] =
                1.0 - itemsAnimation!.value;
          } else if (i == selectedPos) {
            _itemsSelectedState![selectedPos!.toInt()] = itemsAnimation!.value;
          } else {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: widget.tabItems[selectedPos!.toInt()].circleColor),
            ),
          ],
        ),
      ),
